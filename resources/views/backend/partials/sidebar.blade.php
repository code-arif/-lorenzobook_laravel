    ...
    <div class="app-sidebar" style="overflow: scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('group') ? 'has-link' : '' }}"
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('channel') ? 'has-link' : '' }}"
                        href="{{ route('admin.channel.index') }}">
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('contact') ? 'has-link' : '' }}"
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('subscriber') ? 'has-link' : '' }}"
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.chat') ? 'has-link' : '' }}"
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.group-chat') ? 'has-link' : '' }}"
                        href="{{ route('admin.group-chat.index') }}">
                        <i class="fa-regular fa-comment-dots side-menu__icon"></i>
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('setting') ? 'has-link' : '' }}"
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('page') ? 'has-link' : '' }}"
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('social') ? 'has-link' : '' }}"
