...
class ChatController extends Controller
{
    ...
    public function list(): JsonResponse
    {
        ...
        $users = User::select('id', 'first_name', 'email', 'cover', 'last_activity_at')
    ...
    public function conversation($receiver_id): JsonResponse
    {
        ...
        $chat = Chat::query()
            ...
            ->with([
                'sender:id,first_name,email,cover,last_activity_at',
        ...
        $data = [
            'receiver' => User::select('id', 'first_name', 'email', 'cover', 'last_activity_at')->where('id', $receiver_id)->first(),
            'sender' => User::select('id', 'first_name', 'email', 'cover', 'last_activity_at')->where('id', $sender_id)->first(),
            'room' => $room,
            'chat' => $chat
        ];
